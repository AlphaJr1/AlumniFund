...
class AppConstants {
  ...
  static const List<Color> progressGray = [
    Color(0xFFD1D5DB),
    Color(0xFF9CA3AF)
  ];
  static const List<Color> progressBronze = [
    Color(0xFFFCD34D),
    Color(0xFFF59E0B)
  ];
  static const List<Color> progressSilver = [
    Color(0xFFFB923C),
    Color(0xFFEA580C)
  ];
  static const List<Color> progressGold = [
    Color(0xFF4ADE80),
    Color(0xFF16A34A)
  ];
  static const List<Color> progressComplete = [
    Color(0xFF14b8a6),
    Color(0xFF0891B2)
  ];
